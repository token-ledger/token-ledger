...
- The sample app confirms starter classpath, bean registration, and Prometheus actuator exposure.

Remaining MVP work:

- Add sample app E2E endpoints that record ledger events and verify `ai.token.*` metrics.
